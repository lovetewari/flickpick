  ...
  return (<><StarBG/>
    <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 max-w-[400px] mx-auto">
      ...
      <div className="glass p-6 w-full" style={{animation:'slideUp .6s ease .15s both'}}>
        <div className="text-center mb-5"><span className="text-white/30 text-[11px] font-semibold tracking-wide">JOINING ROOM</span><div className="text-gold text-3xl font-black tracking-[4px] mt-1" style={{fontFamily:"'Bebas Neue'"}}>{code}</div></div>
